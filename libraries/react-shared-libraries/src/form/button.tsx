  ...
  return (
    <button
      ...
      className={clsx(
        ...
        `${
          secondary
            ? 'bg-third hover:bg-boxHover'
            : 'bg-forth text-white hover:brightness-[1.08] shadow-[0_8px_22px_-10px_rgba(107,163,218,0.65)]'
        } rounded-[12px] px-[24px] h-[40px] text-[14px] font-[600] cursor-pointer items-center justify-center flex relative transition-all duration-200 active:scale-[0.97]`,
        props?.className
      )}
    >
      {loading && (

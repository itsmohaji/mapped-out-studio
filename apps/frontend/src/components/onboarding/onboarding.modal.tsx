  ...
  return (
    <div className="flex flex-col gap-[24px]">
      ...
      <div className="flex justify-end pt-[24px] mt-[8px]">
        <button
          onClick={onNext}
          className="group flex items-center gap-[12px] bg-gradient-to-r from-[#4a86c9] to-[#6ba3da] hover:from-[#3f86bd] hover:to-[#7db4e8] text-white font-semibold px-[32px] py-[14px] rounded-[12px] text-[16px] transition-all shadow-lg shadow-[#6ba3da]/25 hover:shadow-[#6ba3da]/40"
        >
          {sortedIntegrations.length > 0
            ? t('continue', 'Continue')

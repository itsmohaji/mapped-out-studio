...
export const Support = () => {
  ...
  return (
    <div
      id="support-discord"
      className="bg-customColor39 w-[194px] h-[58px] fixed end-[20px] bottom-[20px] z-[500] text-[16px] text-customColor40 rounded-[30px] !rounded-ee-[0] cursor-pointer flex justify-center items-center gap-[10px]"
